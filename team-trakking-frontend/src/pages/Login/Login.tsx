              ...
              <div className="space-y-4">
                <div>
                  <label
                    ...
                    className={`text-text-muted font-base block py-1 text-sm`}
                  >
                    Email address
                  </label>
                  <Input
                ...
                <div>
                  <label
                    htmlFor="password"
                    className={`text-text-muted font-base mb-1 block py-1 text-sm`}
                  >
                    Password
                  </label>
                  <Input
              ...
              <div>
                <div className="relative my-4">
                  ...
                  <div className="relative flex justify-center text-sm">
                    <span className={`bg-bg-primary text-text-primary px-2`}>
                      Or continue with
                    </span>
                  </div>
                </div>
