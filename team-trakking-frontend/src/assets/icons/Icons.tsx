...
export const GoogleIcon = () => (
  ...
  >
    <path fill="#EA4335" d="M12.2 10.9L5.5 6.3V0h13.2v6.3z" />
    <path fill="#FBBC05" d="M12.2 10.9L5.5 15.5V24h13.2v-8.5z" />
    <path fill="#34A853" d="M18.7 10.9V15.5l5.5 3.6V7.3z" />
    <path fill="#4285F4" d="M5.5 0v6.3l6.7 4.6 6.7-4.6V0z" />
  </svg>
);
