...
const ComponentShowcase: React.FC = () => {
    ...
    return (
        ...
        ${darkMode ?
                ...
                <Button  variant={"none"} className={'border-1 w-[400px] border-blue-500'} size="md">
                    Outline Button
                </Button>

                <Button
                    variant="link"
                    className="relative inline-block hover:text-blue-700 underline-offset-5 transition ease-in-out duration-300 group"
                    size="sm"
                >
                    Link Button
                ...
                <Button
                    className="relative inline-block  group text-blue-700 hover:text-blue-700 transition ease-in-out duration-300"
                >
                ...
                <Button loading={loading} className={'text-red-500 rounded-4 px-1  hover:bg-gray-300 hover:text-green-700'} onClick={handleLoadingClick}>
