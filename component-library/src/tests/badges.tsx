...
const BadgeComponentTest: React.FC = () => {
    return (
        <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap', padding: '20px', backgroundColor: '#f5f5f5' }}>
            <h3>Predefined Variants</h3>
            <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap', width: '100%', marginBottom: '20px' }}>
