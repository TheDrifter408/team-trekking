...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(
    ({ leftIcons = [], rightIcons = [], className = "", loading = false, disabled = false, children, ...props }, ref) => {
        ...
        const renderIcons = (icons: Array<{ icon: ReactNode; onClick?: (e: MouseEvent<HTMLSpanElement>) => void }>) => (
