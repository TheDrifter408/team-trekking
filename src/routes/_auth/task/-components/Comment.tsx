      ...
      <div className="flex items-center justify-between hover:bg-slate-50 border-t rounded-b-xl py-2 px-5">
        ...
        <div className="flex flex-nowrap gap-2">
          ...
          <Tooltip>
            ...
            <TooltipContent>React to this comment</TooltipContent>
          </Tooltip>
        </div>
        <div>
          ...
          {comment.reply ? (
            <Button
              size="sm"
              className="flex gap-2 hover:bg-slate-200 text-muted-foreground py-1 px-2 text-xs font-medium"
              variant={'ghost'}
            >
              {comment.reply.count} Reply
              <AssigneeAvatar
                assignee={comment.reply.author}
                displayName={false}
                onRemove={() => {}}
              />
            </Button>
            ...
            <Button
              variant="ghost"
              className="text-muted-foreground py-1 px-2 text-xs font-medium hover:bg-slate-200"
            >
              Reply
            </Button>
          )}
