...
export const Comment: FC<CommentProps> = ({ assignee, date, comment }) => {
    ...
    const formattedDate = convertedDate.replace(',', ' at');
    ...
    return (
        <div className="grid gap-2 border rounded-xl w-full text-base">
            <div className="flex items-center rounded-xl justify-between p-5">
                ...
                <div className="group relative">
                    {/* Menu onHover */}
                    <div className='absolute bg-white top-0 right-0 rounded-xl invisible group-hover:visible'>
                    ...
                    <span className="text-muted-foreground text-nowrap text-sm">{formattedDate}</span>
                </div>
            </div>
            {/* Comment Content */}
