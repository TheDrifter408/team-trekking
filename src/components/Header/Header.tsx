...
export function Header() {
  ...
  return (
    <header className="fixed left-0 right-0 top-0 z-30 flex h-16 items-center justify-between  bg-bg-primary px-4 shadow-sm">
      {/* Logo & App Name */}
      ...
      <div className="flex items-center space-x-4">
        ...
        <div className="relative">
          <button
            ...
            className="relative rounded-lg bg-bg-inverted p-2 text-gray-600 hover:bg-gray-100"
          >
            ...
            <div className="absolute right-0 mt-2 w-48 rounded-lg border border-gray-300 bg-bg-inverted shadow-lg dark:border-gray-700">
              <div className="py-2">
                ...
                <div
                  ...
                  className="flex cursor-pointer items-center justify-between rounded-lg px-4 py-2 text-sm text-text-inverted hover:bg-bg-secondary hover:text-text-primary"
                >
