...
import { Command, CommandEmpty, CommandList, CommandInput, CommandGroup, CommandItem } from "@/components/shadcn-ui/command";
import { Button } from "../shadcn-ui/button";
import { AssigneeAvatar, AssigneeProps } from "@/components/common/assignee-avatar";
        ...
        <div className="flex -space-x-2 w-full">
            ...
            <Popover modal={false}>
                <PopoverTrigger asChild>
                    ...
                    >
                        {value.length > 0 ? renderAvatars(value, toggleAssignee, isMouseEnter) : (
