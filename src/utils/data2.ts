                ...
                tasks: [
                  {
                    ...
                    comments: [
                      { id: '1', userId: '2', userName: 'Jane Smith', userAvatar: 'https://randomuser.me/api/portraits/women/2.jpg', content: 'I think we should focus on a more minimalist approach', timestamp: new Date('2025-03-11T11:30:00'), likes: 2 },
                      { id: '2', userId: '1', userName: 'John Doe', userAvatar: 'https://randomuser.me/api/portraits/men/1.jpg', content: 'Agreed. Let\'s try to reduce the complexity', timestamp: new Date('2025-03-12T09:45:00'), likes: 1,  }
                    ],
